...
export interface ApiAboutAbout extends SingleTypeSchema {
  ...
  attributes: {
    headshot: MediaAttribute & RequiredAttribute;
    bio: RichTextAttribute & RequiredAttribute;
    email: EmailAttribute;
...
export interface ApiJewelryJewelry extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    ...
    slug: UIDAttribute<'api::jewelry.jewelry', 'title'>;
